...
_C.AUG.PERSPECTIVE = False
# blur probability
_C.AUG.BLUR_PROB = 0.1
# blur radius
_C.AUG.BLUR_RADIUS = 0.1
...
# weight decay
_C.SOLVER.WEIGHT_DECAY = 1e-4 #0.00004
# lr scheduler mode
_C.SOLVER.LR_SCHEDULER = "poly"

_C.SOLVER.POLY = CN()
# poly power
_C.SOLVER.POLY.POWER = 0.9

_C.SOLVER.WARMUP = CN()
# warm up epochs can be float
_C.SOLVER.WARMUP.EPOCHS = 0.
# warm up factor
_C.SOLVER.WARMUP.FACTOR = 1.0 / 3
# warm up method
_C.SOLVER.WARMUP.METHOD = 'linear'
# learning
_C.SOLVER.LR = 0.00005

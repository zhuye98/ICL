...
parser.add_argument('--exp', type=str,
                    default='BraTS19/SwinUnet-FullyS', help='experiment_name')
parser.add_argument('--model', type=str,
                    default='swinunetr', help='model_name')
...
def train(args, snapshot_path):
    ...
    if args.use_ssl_pretrained:
        try:
            model_dict = torch.load("/mntnfs/med_data5/yezhu/pretrained_models/model_swinvit.pt")

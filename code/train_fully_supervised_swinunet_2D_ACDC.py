...
from networks.vision_transformer_base import SwinUnet as ViT_seg

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str,
                    default='../data/ACDC', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='ACDC/SwinUnet-FullyS', help='experiment_name')
...
parser.add_argument('--patch_size', type=int,  default=[224, 224],
...
def train(args, snapshot_path):
    ...
    print("Total silices is: {}".format(labeled_slice))
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                for i_batch, sampled_batch in enumerate(valloader):
                    metric_i = test_single_volume(sampled_batch["image"], sampled_batch["label"], model, classes=num_classes, patch_size=[224, 224])
